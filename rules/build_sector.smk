...
rule build_energy_totals:
    ...
    input:
        ...
        ########## swiss="data/switzerland-new_format-all_years.csv", ########## quito esto
        ########## swiss_transport="data/gr-e-11.03.02.01.01-cc.csv", ########## quito esto
        idees="data/bundle-sector/jrc-idees-2015",
        ########## district_heat_share="data/district_heat_share.csv", ########## quito esto
